...
**GitHub Repository:** [https://github.com/bitmap4/cp-a5](https://github.com/bitmap4/cp-a5)
...
**P = 1.0 x 0.6 x 0.5 x 0.34 x 0.2 x 0.8 x 1.0 x 0.6 x 0.5 x 0.33 x 1.0 x 1.0 x 0.6 x 0.5 x 0.33 = 0.000160**

### Parser Output

The parser correctly selects **Parse 1 (NP attachment)** as the best parse, since P(Parse 1) = 0.000320 > P(Parse 2) = 0.000160.
...
scan for duplicates), the total time would increase to O($n^4$),
